...
public class Constant {
    ...
    public static String SELFCERTPATH = Constant.class.getClassLoader().getResource("outgoing.CertwithKey.pkcs12").getPath();//"/outgoing.CertwithKey.pkcs12";
    public static String TRUSTCAPATH = Constant.class.getClassLoader().getResource("ca.jks").getPath();//"/ca.jks";
